    ...
    <div class="page-header">
        <div class="header-content">
            <div class="header-title-wrapper">
                <div class="title-icon animate-float">
                    <i data-lucide="tool"></i>
                </div>
                <div>
                    <h1>Créer une intervention</h1>
                    <p class="subtitle">Créez une nouvelle demande de maintenance pour un bien délégué</p>
                </div>
            </div>
        </div>
        <a href="{{ route('co-owner.maintenance.index') }}" class="btn-back animate-hover">
            ...
            <div class="tab-content" id="tab-3">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            <i data-lucide="euro" class="input-icon"></i>
                            <input type="number"
                                   name="estimated_cost"
                                   id="estimated_cost"
                                   class="form-input"
...
<style>
  ...
  :root {
        ...
        --gray-700: #374151;
        --gray-800: #1f2937;
        --gradient-primary: linear-gradient(135deg, var(--primary-blue) 0%, var(--secondary-sky) 100%);
