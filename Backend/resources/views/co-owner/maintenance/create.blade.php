...
<div class="maintenance-container" style="border-radius: 5%;">
    ...
    <div class="form-card animate-slide-up">
        ...
        <form method="POST" action="{{ route('co-owner.maintenance.store') . (request()->get('api_token') ? '?api_token=' . request()->get('api_token') : '') }}" enctype="multipart/form-data" class="maintenance-form" id="maintenanceForm">
            @csrf
