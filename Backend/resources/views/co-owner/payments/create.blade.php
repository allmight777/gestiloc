...
<div class="content-container">
   ...
   <div class="content-header" style="display: flex; justify-content: space-between; align-items: center; gap: 20px;">
    ...
    <div>
        ...
        <p style="margin: 6px 0 0 42px; color: #6b7280;">
            Créez un nouveau paiement pour un locataire
        </p>
    </div>

    <!-- Bouton à droite -->
    <div class="top-actions">
        <a href="{{ route('co-owner.payments.index') }}"
            ...
            <form method="POST" action="{{ route('co-owner.payments.store') }}" class="form-card" id="paymentForm">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                <i data-lucide="message-square" style="width: 16px; height: 16px;"></i> Notes additionnelles
                            </label>
                            <textarea name="notes"
...
<style>
    ...
    .info-header h3, .summary-header h3 {
        font-size: 0.95rem;
        font-weight: 950;
        color: var(--indigo);
        margin: 0;
