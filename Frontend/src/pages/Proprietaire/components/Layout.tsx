...
export const Layout: React.FC<LayoutProps> = ({
  ...
  const handlePageChange = (page: string) => {
    ...
    const validTabIds = [
      ...
      'comptabilite', 'parametres', 'profil', 'coproprietaires',
      'inviter-coproprietaire'
    ];
  ...
  // Icônes pour les co-propriétaires
  const SvgUsers = () => (
    <svg viewBox="0 0 24 24" width={18} height={18} fill="none" stroke="#9C27B0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // ── Menu sections avec AJOUT de la section GESTIONNAIRES ──
  const menuSections = [
    {
  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'profil', label: 'Mon compte', icon: <SideIcon src="customer.png" /> },
