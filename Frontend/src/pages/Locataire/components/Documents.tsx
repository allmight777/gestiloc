        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="relative w-full md:w-64">
                <input 
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:ring-blue-600 focus:border-blue-600 text-sm"
                />
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2">
                                                <h3 className="font-medium text-gray-900 group-hover:text-blue-600 transition-colors">{file.name}</h3>
                                                {file.tag && (
